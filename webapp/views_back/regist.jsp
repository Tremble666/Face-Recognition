...
<body>
	...
	<div style="position:absolute;top:15%;left:13%">
				...
				<div class="col-md-offset-3 col-md-6">	
					<form class="form-horizontal"  onSubmit="return check_password();" action="/facerecognition/regist?cmd=judgeGoOn" method="post">
						...
						<div class="form-group">
							<input type="text" name="name" class="form-control" id="username" placeholder="username"onblur="check_username(this,document.getElementById('usernamecheck'))">
							<i class="fa fa-user"></i>
							<nobr><span style="position:absolute;top:40px;left:50px;color:red"id="usernamecheck"></span></nobr>
						...
						<div class="form-group help">
							...
							<input type="submit" class="btn btn-success" style="position:absolute; onclick=" check() left:60px;width:470px"
						value="regist" />
						</div>
