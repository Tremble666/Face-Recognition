		...
		<div class="container">
			<div class="row">
				<div class="col-md-offset-3 col-md-6">
					<form class="form-horizontal" action="/facerecognition/logon?cmd=finalLogon" method="post">
						<span class="heading">LOGIN	</span>
						<div class="form-group">
							<input type="email" class="form-control" id="inputEmail3" placeholder="email" required name = "email" value = ${email}>
							<i class="fa fa-user"></i>
						</div>
						<div class="form-group help">
							<input type="password" class="form-control" id="inputPassword3" placeholder="password" required name = "password" value = ${password} >
							<i class="fa fa-lock"></i>
							<nobr><span style="position:absolute;top:40px;left:50px;color:red"id="usernamecheck">${errorLog}</span></nobr>
