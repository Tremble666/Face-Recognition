...
<body>
	...
	<div style="background-color: white; margin-top: -10px;"
		...
		<h2 style="font-size: 40px;">
			...
			<a class="btn btn-primary btn-lg" href="/facerecognition/about?cmd=learn" role="button">Learn
				more</a>
		</p>
	</div>
	...
	<div style="background-color: white; margin-top: -50px;"
		...
		<h2 style="font-size: 40px;">
			...
			<a class="btn btn-primary btn-lg" href="/facerecognition/about?cmd=help" role="button">H e l p</a>
		</p>
	</div>
	...
	<div style="background-color: white; margin-top: -50px;"
		...
		<h2 style="font-size: 40px;">
			<img style="margin-top: -10px" width="30px" height="30px"
				src="/Img/人脸识别.png">&nbsp;&nbsp; <b>Welcome to use it!</b>
		</h2>	
			
		<p>
			<a class="btn btn-primary btn-lg" href="/facerecognition/circleFace?cmd=useSub" role="button">Circle Face</a>
			&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
			&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
			<a class="btn btn-primary btn-lg" href="/facerecognition/about?cmd=function" role="button">Face Recognition</a>
			&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
			&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
			<a class="btn btn-primary btn-lg" href="/facerecognition/drawFace?cmd=useSub" role="button">Draw Face</a>
		</p>
	</div>
